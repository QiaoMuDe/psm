...
const API = {
    ...
    generateNameFromContent: (content) => API.call(window.go.main.App.GenerateNameFromContent, content),
    generateDescriptionFromContent: (content) => API.call(window.go.main.App.GenerateDescriptionFromContent, content),
