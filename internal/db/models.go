...
func DefaultSettings(appHome string) []Settings {
	return []Settings{
		...
		{Key: "ai_generate_name_prompt", Value: "你是一个命名专家。用户会给你一段提示词内容，请你根据内容生成一个简短、概括性的名称。\n\n要求：\n- 名称应准确反映内容的核心功能\n- 长度控制在 20 字以内\n- 内容应为中文\n\n直接返回生成的名称，不要包含解释、引号或其他格式。"},
		{Key: "ai_generate_desc_prompt", Value: "你是一个描述生成专家。用户会给你一段技能的正文内容，请你根据内容生成一段简洁的描述。\n\n要求：\n- 描述应准确概括技能的核心功能和用途\n- 长度控制在 50 字以内\n- 内容应为中文\n\n直接返回生成的描述，不要包含解释、引号或其他格式。"},
